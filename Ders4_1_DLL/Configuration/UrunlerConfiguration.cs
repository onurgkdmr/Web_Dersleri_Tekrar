...
public class UrunlerConfiguration : IEntityTypeConfiguration<Urunler>
{
    public void Configure(EntityTypeBuilder<Urunler> builder)
    {
        ...
        builder.Property(k => k.Stok).IsRequired(true); // IsRequired(true) => true değeri girişi zorunlu, boş geçilemez anlamına gelir. false değeri ise boş geçilebilir anlamına gelir.
